...
const descriptor_t Descriptor =
{
  ...
  0x10000000,                                  // ram start address (for bootloader storage)
  ...
  DESCRIPTOR_BOOTSTRAP_BOOTROM,                // use BootROM feature to download this bootloader
  ...
  "LPC1850",                                   // name of device
  "S25FL129P LPC1850/LPC4350 Hitex",           // name (DESCRIPTOR_MAXNAMELENGTH characters or shorter)
  "SPIFI on Hitex eval board",                 // description (DESCRIPTOR_MAXDESCLENGTH characters or shorter)
  "Connect SV5 pin 2 to SV1 pin 5 and SV5 pin 8 to SV1 pin 7;Remove all other SV1 and SV5 jumpers;Connect Flash Magic to X1;Connect BOOT1 pins 2-3, BOOT2 pins 2-3, BOOT3 pins 2-3, BOOT4 pins 1-2", // notes (DESCRIPTOE_MAXNOTESLENGTH characters or shorter) - use semicolons for newlines
