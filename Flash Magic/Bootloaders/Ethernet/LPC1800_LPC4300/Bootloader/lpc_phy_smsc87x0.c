...
uint32_t lpc_phy_init(bool rmii, p_msDelay_func_t pDelayMsFunc)
{
	...
	Chip_SCU_PinMux(0xD, 14, SCU_MODE_PULLUP, SCU_MODE_FUNC4); 	// Ethernet RESET
	Chip_GPIO_SetPinDIR(LPC_GPIO_PORT, 6, 28, 1);
	Chip_GPIO_SetPinOutHigh(LPC_GPIO_PORT, 6, 28);	
