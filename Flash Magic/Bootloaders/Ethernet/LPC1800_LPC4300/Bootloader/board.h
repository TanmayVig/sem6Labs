...
/** @defgroup BOARD_KEIL_MCB_1857 LPC1857 Keil MCB board support software API functions
 * @ingroup LPCOPEN_18XX_BOARD_KEIL1857
...
/** @defgroup BOARD_KEIL_MCB_1857_OPTIONS BOARD: LPC1857 Keil MCB board build options
